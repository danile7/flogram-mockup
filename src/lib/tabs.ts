...
import { expand_path_to_file } from './store/expanded_paths';
import { mobile_showing, showing_files } from './store/mobile_showing_store';
import { editor_config } from './store/editor_config_store';
...
export function open_file(path: string) {
	...
	editor_config.unselect_help_tab();
}
