...
<form>
	...
	{:else}
		<p>
			Enter a valid Github Repository URL like <code>https://github.com/Flogram</code>
			or use a folder path like
			<code
				>https://github.com/Flogram/tree/main/src/lib/default_project_files/tailwind</code
			>.
		</p>
		<p>
